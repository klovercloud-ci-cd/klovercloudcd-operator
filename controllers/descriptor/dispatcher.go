...
import (
	...
	"github.com/klovercloud-ci-cd/klovercloudcd-operator/controllers/descriptor/v0_0_1_beta/security"
...
func ApplySecurity(client client.Client,namespace string,db v1alpha1.DB, v1alpha1Security v1alpha1.Security, version string) error{
	if version==string(enums.V0_0_1_BETA){
		return security.New(client).ModifyConfigmap(namespace,db,v1alpha1Security).ModifyDeployment(namespace,v1alpha1Security).Apply(true)
	}
